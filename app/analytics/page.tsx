        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">12,547</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">$84,219</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-2">
              ...
              <span className="text-sm font-medium text-gray-900">2,847 views</span>
            </div>
            <div className="flex items-center justify-between py-2">
              <span className="text-gray-600">/products</span>
              <span className="text-sm font-medium text-gray-900">1,923 views</span>
            </div>
            <div className="flex items-center justify-between py-2">
              <span className="text-gray-600">/about</span>
              <span className="text-sm font-medium text-gray-900">1,456 views</span>
            </div>
            <div className="flex items-center justify-between py-2">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-sm text-gray-900">Conversion rate declined by 2%</p>
